...
class RentalCommercialSpacesScreen extends StatefulWidget {
  const RentalCommercialSpacesScreen({super.key});

  @override
  State<RentalCommercialSpacesScreen> createState() =>
      _RentalCommercialSpacesScreenState();
}

class _RentalCommercialSpacesScreenState
    extends State<RentalCommercialSpacesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final listingsQuery = FirebaseFirestore.instance
        ...
        .where('rentType', isEqualTo: 'commercial')
        .limit(100);
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Commercial Spaces'),
                  ...
                  builder: (context, requestsSnapshot) {
                      ...
                      return Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'No commercial spaces available',
                              style: TextStyle(
                      ...
                      return Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            Text(
                              'No commercial spaces to rent in this location',
                              style: TextStyle(
                                color: Colors.grey[600],
                                fontSize: 18,
                                fontWeight: FontWeight.w600,
                    ...
                    return GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final title = (listing['title'] ?? 'Commercial Space')
                            .toString();
                        final address =
