          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                ...
                // Filter by selected barangay (location contains selected name)
                    ...
                    >(
                      ...
                      builder: (context, itemSnap) {
                        ...
                        final denormTitle = (listing['title'] as String?)
                            ?.trim();
                        final denormCategory = (listing['category'] as String?)
                            ?.trim();
                        final denormImage = (listing['imageUrl'] as String?)
                            ?.trim();
                        final denormLocation = (listing['location'] as String?)
                            ?.trim();
